...
module.exports = {
    ...
    json2csvStream: (json, options) => stream(Json2Csv, json, options),
...
/**
 * Abstracted streaming converter function for json2csv and csv2json functionality
 * Takes in the converter to be used (either Json2Csv or Csv2Json)
 * @param converter
 * @param data
 * @param options
 */
function stream(converter, data, options) {
    return utils.stream({
        data: data,
        options,
        converter: converter
